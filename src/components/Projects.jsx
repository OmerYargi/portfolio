...
const projects = [
  {
    ...
    description: 'Kullanıcıların akıllı telefonlarını satabileceği yapay zeka tabanlı dinamik fiyatlandırma platformu. Cihaz durumuna göre anlık değerleme.',
  ...
  },
  {
    ...
    description: 'Three.js ile geliştirilen, ürünlerin 3D özelleştirilmesine ve müşteri sitelerine gömülmesine olanak tanıyan embeddable platform.',
  ...
  },
  {
    ...
    description: 'DIA ERP, Ticimax ve Entegra sistemleri ile e-ticaret platformlarını konuşturan entegrasyon katmanı. Stok, sipariş, fatura senkronizasyonu.',
    tags: ['NextJS', 'Fastify', 'PostgreSQL'],
    color: 'pink',
    href: '#',
  },
  {
    ...
    description: 'Performans, erişilebilirlik ve modern UI/UX odaklı kurumsal ve tanıtım web siteleri. Figma\'dan canlıya tüm süreç.',
    tags: ['NextJS', 'Figma', 'Tailwind'],
    color: 'amber',
    href: '#',
  },
]
